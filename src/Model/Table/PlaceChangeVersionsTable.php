...
/**
 * PlaceChangeVersions Model
 */
class PlaceChangeVersionsTable extends Table
{
    ...
    {
        $this->table('place_change_versions');
    ...
    public function validationDefault(Validator $validator)
    {
        $validator
            ...
            ->notEmpty('event_id')
            ->add('place_change_id', 'valid', ['rule' => 'numeric'])
            ->requirePresence('place_change_id', 'create')
            ->notEmpty('place_change_id');
    ...
    public function buildRules(RulesChecker $rules)
    {
        ...
        $rules->add($rules->existsIn(['place_change_id'], 'PlaceChanges'));
        return $rules;
    }
}
