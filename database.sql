...
MySQL - 5.6.19-0ubuntu0.14.04.1 : Database - mapster
*********************************************************************
*/
...
/*Table structure for table `character_change_versions` */

DROP TABLE IF EXISTS `character_change_versions`;

CREATE TABLE `character_change_versions` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL,
  `description` text,
  `image` text,
  ...
  `character_change_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `universe_id` (`universe_id`),
  KEY `character_id` (`character_id`),
  KEY `character_change_id` (`character_change_id`),
  CONSTRAINT `character_change_versions_ibfk_1` FOREIGN KEY (`universe_id`) REFERENCES `universes` (`id`),
  CONSTRAINT `character_change_versions_ibfk_2` FOREIGN KEY (`character_id`) REFERENCES `characters` (`id`),
  CONSTRAINT `character_change_versions_ibfk_3` FOREIGN KEY (`character_change_id`) REFERENCES `character_changes` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

/*Data for the table `character_change_versions` */

/*Table structure for table `character_changes` */

DROP TABLE IF EXISTS `character_changes`;
...
CREATE TABLE `character_changes` (
  ...
  KEY `universe_id` (`universe_id`),
  KEY `character_id` (`character_id`),
  CONSTRAINT `character_changes_ibfk_1` FOREIGN KEY (`universe_id`) REFERENCES `universes` (`id`),
  CONSTRAINT `character_changes_ibfk_2` FOREIGN KEY (`character_id`) REFERENCES `characters` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

/*Data for the table `character_changes` */
...
insert  into `event_versions`(`id`,`name`,`description`,`link`,`sequence`,`chapter_id`,`created`,`event_id`) values (1,'The Two Rivers','The early chapters of the book are set in and around the rustic village of Emond\'s Field in the Two Rivers region of Andor, where most of the primary characters reside.\n\nOn the eve of Bel Tine (an annual festival celebrating the arrival of spring), an unexpected attack by bestial Trollocs and fearsome Myrddraal seems to target Rand al\'Thor and his two friends, Matrim Cauthon and Perrin Aybara, specifically. Hoping to spare their loved ones and village from further attacks, the three young men resolve to flee the village by night, accompanied by Moiraine Damodred, an Aes Sedai, and her Warder, al\'Lan Mandragoran. As they attempt to leave, they are discovered by the innkeeper\'s daughter, Egwene al\'Vere, and a wandering gleeman, Thom Merrilin, who join them.',NULL,1,11,'2014-09-26 15:46:55',1),(2,'From The Two Rivers to Shadar Logoth','Chased by Trollocs, Myrddraal, and Draghkar, the seven companions make their way to the nearby city of Baerlon, where they encounter Min Farshaw, a young woman gifted with prophetic visions, as well as Dain Bornhald, an officer of the Children of the Light. They also find Padan Fain, a peddler who was presumed dead after the Trolloc attack on Emond\'s Field. Also in Baerlon, Rand and his two friends begin experiencing dreams in which they are taunted by an arrogant man who calls himself Ba\'alzamon. Shortly before they depart, Nynaeve al\'Meara, the village wisdom of Emond\'s Field, arrives to retrieve the four villagers. When Rand and his friends refuse to return with her, Nynaeve joins them to ensure their continued safety. \n\nPursued by ever-increasing numbers of Trollocs and Myrddraal, the travellers are forced to take refuge in the ancient, abandoned, and deadly city of Shadar Logoth, a place even Myrddraal are reluctant to enter. While Rand and his two friends foolishly try to explore the ruined city, they meet a strange man named Mordeth. He first offers them riches in exchange for a small favor, then attempts to kill them when he learns that their companions include an Aes Sedai and that their eventual destination is Tar Valon, the home city of the Aes Sedai order. The three barely escape, and only reach their companions just before nightfall. ','',2,20,'2014-09-26 15:47:39',2),(3,'Logain','Logain Ablar, a recently-captured False Dragon, is being paraded through the streets of Caemlyn. While seeking to catch a glimpse of him, Rand climbs a wall and accidentally falls over the top into the palace garden, where he meets Elayne Trakand, heir-apparent to the throne of Andor, her brother Gawyn, and her half-brother Galad Damodred. \n\nWhen Rand\'s presence is discovered by the palace guards with Galad\'s help, he is taken into custody despite Elayne\'s protests and brought before Queen Morgase and her Aes Sedai advisor, Elaida. Elaida prophetically identifies Rand as a dangerous individual, but Queen Morgase decides that she does not have sufficient evidence to imprison him.',NULL,9,41,'2014-09-26 16:05:10',9),(4,'The Two Rivers','The early chapters of the book are set in and around the rustic village of Emond\'s Field in the Two Rivers region of Andor, where most of the primary characters reside.\n\nOn the eve of Bel Tine (an annual festival celebrating the arrival of spring), an unexpected attack by bestial Trollocs and fearsome Myrddraal seems to target Rand al\'Thor and his two friends, Matrim Cauthon and Perrin Aybara, specifically. Hoping to spare their loved ones and village from further attacks, the three young men resolve to flee the village by night, accompanied by Moiraine Damodred, an Aes Sedai, and her Warder, al\'Lan Mandragoran. As they attempt to leave, they are discovered by the innkeeper\'s daughter, Egwene al\'Vere, and a wandering gleeman, Thom Merrilin, who join them.',NULL,2,11,'2015-01-14 15:46:12',1),(5,'The Two Rivers','The early chapters of the book are set in and around the rustic village of Emond\'s Field in the Two Rivers region of Andor, where most of the primary characters reside.\n\nOn the eve of Bel Tine (an annual festival celebrating the arrival of spring), an unexpected attack by bestial Trollocs and fearsome Myrddraal seems to target Rand al\'Thor and his two friends, Matrim Cauthon and Perrin Aybara, specifically. Hoping to spare their loved ones and village from further attacks, the three young men resolve to flee the village by night, accompanied by Moiraine Damodred, an Aes Sedai, and her Warder, al\'Lan Mandragoran. As they attempt to leave, they are discovered by the innkeeper\'s daughter, Egwene al\'Vere, and a wandering gleeman, Thom Merrilin, who join them.',NULL,1,11,'2015-01-14 15:46:18',1),(6,'The Two Rivers','The early chapters of the book are set in and around the rustic village of Emond\'s Field in the Two Rivers region of Andor, where most of the primary characters reside.\n\nOn the eve of Bel Tine (an annual festival celebrating the arrival of spring), an unexpected attack by bestial Trollocs and fearsome Myrddraal seems to target Rand al\'Thor and his two friends, Matrim Cauthon and Perrin Aybara, specifically. Hoping to spare their loved ones and village from further attacks, the three young men resolve to flee the village by night, accompanied by Moiraine Damodred, an Aes Sedai, and her Warder, al\'Lan Mandragoran. As they attempt to leave, they are discovered by the innkeeper\'s daughter, Egwene al\'Vere, and a wandering gleeman, Thom Merrilin, who join them.',NULL,2,11,'2015-01-14 15:47:04',1),(7,'The Two Rivers','The early chapters of the book are set in and around the rustic village of Emond\'s Field in the Two Rivers region of Andor, where most of the primary characters reside.\n\nOn the eve of Bel Tine (an annual festival celebrating the arrival of spring), an unexpected attack by bestial Trollocs and fearsome Myrddraal seems to target Rand al\'Thor and his two friends, Matrim Cauthon and Perrin Aybara, specifically. Hoping to spare their loved ones and village from further attacks, the three young men resolve to flee the village by night, accompanied by Moiraine Damodred, an Aes Sedai, and her Warder, al\'Lan Mandragoran. As they attempt to leave, they are discovered by the innkeeper\'s daughter, Egwene al\'Vere, and a wandering gleeman, Thom Merrilin, who join them.',NULL,1,11,'2015-01-14 15:49:11',1),(8,'The Two Rivers','The early chapters of the book are set in and around the rustic village of Emond\'s Field in the Two Rivers region of Andor, where most of the primary characters reside.\n\nOn the eve of Bel Tine (an annual festival celebrating the arrival of spring), an unexpected attack by bestial Trollocs and fearsome Myrddraal seems to target Rand al\'Thor and his two friends, Matrim Cauthon and Perrin Aybara, specifically. Hoping to spare their loved ones and village from further attacks, the three young men resolve to flee the village by night, accompanied by Moiraine Damodred, an Aes Sedai, and her Warder, al\'Lan Mandragoran. As they attempt to leave, they are discovered by the innkeeper\'s daughter, Egwene al\'Vere, and a wandering gleeman, Thom Merrilin, who join them.',NULL,2,11,'2015-01-14 15:49:29',1),(9,'The Two Rivers','The early chapters of the book are set in and around the rustic village of Emond\'s Field in the Two Rivers region of Andor, where most of the primary characters reside.\n\nOn the eve of Bel Tine (an annual festival celebrating the arrival of spring), an unexpected attack by bestial Trollocs and fearsome Myrddraal seems to target Rand al\'Thor and his two friends, Matrim Cauthon and Perrin Aybara, specifically. Hoping to spare their loved ones and village from further attacks, the three young men resolve to flee the village by night, accompanied by Moiraine Damodred, an Aes Sedai, and her Warder, al\'Lan Mandragoran. As they attempt to leave, they are discovered by the innkeeper\'s daughter, Egwene al\'Vere, and a wandering gleeman, Thom Merrilin, who join them.',NULL,1,11,'2015-01-14 15:50:20',1),(10,'The Two Rivers','The early chapters of the book are set in and around the rustic village of Emond\'s Field in the Two Rivers region of Andor, where most of the primary characters reside.\n\nOn the eve of Bel Tine (an annual festival celebrating the arrival of spring), an unexpected attack by bestial Trollocs and fearsome Myrddraal seems to target Rand al\'Thor and his two friends, Matrim Cauthon and Perrin Aybara, specifically. Hoping to spare their loved ones and village from further attacks, the three young men resolve to flee the village by night, accompanied by Moiraine Damodred, an Aes Sedai, and her Warder, al\'Lan Mandragoran. As they attempt to leave, they are discovered by the innkeeper\'s daughter, Egwene al\'Vere, and a wandering gleeman, Thom Merrilin, who join them.',NULL,2,11,'2015-01-14 15:50:29',1),(11,'From The Two Rivers to Shadar Logoth','Chased by Trollocs, Myrddraal, and Draghkar, the seven companions make their way to the nearby city of Baerlon, where they encounter Min Farshaw, a young woman gifted with prophetic visions, as well as Dain Bornhald, an officer of the Children of the Light. They also find Padan Fain, a peddler who was presumed dead after the Trolloc attack on Emond\'s Field. Also in Baerlon, Rand and his two friends begin experiencing dreams in which they are taunted by an arrogant man who calls himself Ba\'alzamon. Shortly before they depart, Nynaeve al\'Meara, the village wisdom of Emond\'s Field, arrives to retrieve the four villagers. When Rand and his friends refuse to return with her, Nynaeve joins them to ensure their continued safety. \n\nPursued by ever-increasing numbers of Trollocs and Myrddraal, the travellers are forced to take refuge in the ancient, abandoned, and deadly city of Shadar Logoth, a place even Myrddraal are reluctant to enter. While Rand and his two friends foolishly try to explore the ruined city, they meet a strange man named Mordeth. He first offers them riches in exchange for a small favor, then attempts to kill them when he learns that their companions include an Aes Sedai and that their eventual destination is Tar Valon, the home city of the Aes Sedai order. The three barely escape, and only reach their companions just before nightfall. ','',1,20,'2015-01-14 15:50:43',2),(12,'From The Two Rivers to Shadar Logoth','Chased by Trollocs, Myrddraal, and Draghkar, the seven companions make their way to the nearby city of Baerlon, where they encounter Min Farshaw, a young woman gifted with prophetic visions, as well as Dain Bornhald, an officer of the Children of the Light. They also find Padan Fain, a peddler who was presumed dead after the Trolloc attack on Emond\'s Field. Also in Baerlon, Rand and his two friends begin experiencing dreams in which they are taunted by an arrogant man who calls himself Ba\'alzamon. Shortly before they depart, Nynaeve al\'Meara, the village wisdom of Emond\'s Field, arrives to retrieve the four villagers. When Rand and his friends refuse to return with her, Nynaeve joins them to ensure their continued safety. \n\nPursued by ever-increasing numbers of Trollocs and Myrddraal, the travellers are forced to take refuge in the ancient, abandoned, and deadly city of Shadar Logoth, a place even Myrddraal are reluctant to enter. While Rand and his two friends foolishly try to explore the ruined city, they meet a strange man named Mordeth. He first offers them riches in exchange for a small favor, then attempts to kill them when he learns that their companions include an Aes Sedai and that their eventual destination is Tar Valon, the home city of the Aes Sedai order. The three barely escape, and only reach their companions just before nightfall. ','',2,20,'2015-01-14 15:50:45',2),(13,'From The Two Rivers to Shadar Logoth','Chased by Trollocs, Myrddraal, and Draghkar, the seven companions make their way to the nearby city of Baerlon, where they encounter Min Farshaw, a young woman gifted with prophetic visions, as well as Dain Bornhald, an officer of the Children of the Light. They also find Padan Fain, a peddler who was presumed dead after the Trolloc attack on Emond\'s Field. Also in Baerlon, Rand and his two friends begin experiencing dreams in which they are taunted by an arrogant man who calls himself Ba\'alzamon. Shortly before they depart, Nynaeve al\'Meara, the village wisdom of Emond\'s Field, arrives to retrieve the four villagers. When Rand and his friends refuse to return with her, Nynaeve joins them to ensure their continued safety. \n\nPursued by ever-increasing numbers of Trollocs and Myrddraal, the travellers are forced to take refuge in the ancient, abandoned, and deadly city of Shadar Logoth, a place even Myrddraal are reluctant to enter. While Rand and his two friends foolishly try to explore the ruined city, they meet a strange man named Mordeth. He first offers them riches in exchange for a small favor, then attempts to kill them when he learns that their companions include an Aes Sedai and that their eventual destination is Tar Valon, the home city of the Aes Sedai order. The three barely escape, and only reach their companions just before nightfall. ','',1,20,'2015-01-14 15:58:22',2),(14,'From The Two Rivers to Shadar Logoth','Chased by Trollocs, Myrddraal, and Draghkar, the seven companions make their way to the nearby city of Baerlon, where they encounter Min Farshaw, a young woman gifted with prophetic visions, as well as Dain Bornhald, an officer of the Children of the Light. They also find Padan Fain, a peddler who was presumed dead after the Trolloc attack on Emond\'s Field. Also in Baerlon, Rand and his two friends begin experiencing dreams in which they are taunted by an arrogant man who calls himself Ba\'alzamon. Shortly before they depart, Nynaeve al\'Meara, the village wisdom of Emond\'s Field, arrives to retrieve the four villagers. When Rand and his friends refuse to return with her, Nynaeve joins them to ensure their continued safety. \n\nPursued by ever-increasing numbers of Trollocs and Myrddraal, the travellers are forced to take refuge in the ancient, abandoned, and deadly city of Shadar Logoth, a place even Myrddraal are reluctant to enter. While Rand and his two friends foolishly try to explore the ruined city, they meet a strange man named Mordeth. He first offers them riches in exchange for a small favor, then attempts to kill them when he learns that their companions include an Aes Sedai and that their eventual destination is Tar Valon, the home city of the Aes Sedai order. The three barely escape, and only reach their companions just before nightfall. ','',2,20,'2015-01-14 15:58:26',2),(15,'From The Two Rivers to Shadar Logoth','Chased by Trollocs, Myrddraal, and Draghkar, the seven companions make their way to the nearby city of Baerlon, where they encounter Min Farshaw, a young woman gifted with prophetic visions, as well as Dain Bornhald, an officer of the Children of the Light. They also find Padan Fain, a peddler who was presumed dead after the Trolloc attack on Emond\'s Field. Also in Baerlon, Rand and his two friends begin experiencing dreams in which they are taunted by an arrogant man who calls himself Ba\'alzamon. Shortly before they depart, Nynaeve al\'Meara, the village wisdom of Emond\'s Field, arrives to retrieve the four villagers. When Rand and his friends refuse to return with her, Nynaeve joins them to ensure their continued safety. \n\nPursued by ever-increasing numbers of Trollocs and Myrddraal, the travellers are forced to take refuge in the ancient, abandoned, and deadly city of Shadar Logoth, a place even Myrddraal are reluctant to enter. While Rand and his two friends foolishly try to explore the ruined city, they meet a strange man named Mordeth. He first offers them riches in exchange for a small favor, then attempts to kill them when he learns that their companions include an Aes Sedai and that their eventual destination is Tar Valon, the home city of the Aes Sedai order. The three barely escape, and only reach their companions just before nightfall. ','',1,20,'2015-01-14 15:59:32',2),(16,'From The Two Rivers to Shadar Logoth','Chased by Trollocs, Myrddraal, and Draghkar, the seven companions make their way to the nearby city of Baerlon, where they encounter Min Farshaw, a young woman gifted with prophetic visions, as well as Dain Bornhald, an officer of the Children of the Light. They also find Padan Fain, a peddler who was presumed dead after the Trolloc attack on Emond\'s Field. Also in Baerlon, Rand and his two friends begin experiencing dreams in which they are taunted by an arrogant man who calls himself Ba\'alzamon. Shortly before they depart, Nynaeve al\'Meara, the village wisdom of Emond\'s Field, arrives to retrieve the four villagers. When Rand and his friends refuse to return with her, Nynaeve joins them to ensure their continued safety. \n\nPursued by ever-increasing numbers of Trollocs and Myrddraal, the travellers are forced to take refuge in the ancient, abandoned, and deadly city of Shadar Logoth, a place even Myrddraal are reluctant to enter. While Rand and his two friends foolishly try to explore the ruined city, they meet a strange man named Mordeth. He first offers them riches in exchange for a small favor, then attempts to kill them when he learns that their companions include an Aes Sedai and that their eventual destination is Tar Valon, the home city of the Aes Sedai order. The three barely escape, and only reach their companions just before nightfall. ','',2,20,'2015-01-14 15:59:36',2),(17,'From The Two Rivers to Shadar Logoth','Chased by Trollocs, Myrddraal, and Draghkar, the seven companions make their way to the nearby city of Baerlon, where they encounter Min Farshaw, a young woman gifted with prophetic visions, as well as Dain Bornhald, an officer of the Children of the Light. They also find Padan Fain, a peddler who was presumed dead after the Trolloc attack on Emond\'s Field. Also in Baerlon, Rand and his two friends begin experiencing dreams in which they are taunted by an arrogant man who calls himself Ba\'alzamon. Shortly before they depart, Nynaeve al\'Meara, the village wisdom of Emond\'s Field, arrives to retrieve the four villagers. When Rand and his friends refuse to return with her, Nynaeve joins them to ensure their continued safety. \n\nPursued by ever-increasing numbers of Trollocs and Myrddraal, the travellers are forced to take refuge in the ancient, abandoned, and deadly city of Shadar Logoth, a place even Myrddraal are reluctant to enter. While Rand and his two friends foolishly try to explore the ruined city, they meet a strange man named Mordeth. He first offers them riches in exchange for a small favor, then attempts to kill them when he learns that their companions include an Aes Sedai and that their eventual destination is Tar Valon, the home city of the Aes Sedai order. The three barely escape, and only reach their companions just before nightfall. ','',1,20,'2015-01-14 16:01:40',2),(18,'From The Two Rivers to Shadar Logoth','Chased by Trollocs, Myrddraal, and Draghkar, the seven companions make their way to the nearby city of Baerlon, where they encounter Min Farshaw, a young woman gifted with prophetic visions, as well as Dain Bornhald, an officer of the Children of the Light. They also find Padan Fain, a peddler who was presumed dead after the Trolloc attack on Emond\'s Field. Also in Baerlon, Rand and his two friends begin experiencing dreams in which they are taunted by an arrogant man who calls himself Ba\'alzamon. Shortly before they depart, Nynaeve al\'Meara, the village wisdom of Emond\'s Field, arrives to retrieve the four villagers. When Rand and his friends refuse to return with her, Nynaeve joins them to ensure their continued safety. \n\nPursued by ever-increasing numbers of Trollocs and Myrddraal, the travellers are forced to take refuge in the ancient, abandoned, and deadly city of Shadar Logoth, a place even Myrddraal are reluctant to enter. While Rand and his two friends foolishly try to explore the ruined city, they meet a strange man named Mordeth. He first offers them riches in exchange for a small favor, then attempts to kill them when he learns that their companions include an Aes Sedai and that their eventual destination is Tar Valon, the home city of the Aes Sedai order. The three barely escape, and only reach their companions just before nightfall. ','',2,20,'2015-01-14 16:01:52',2);
...
CREATE TABLE `map_change_versions` (
  ...
  `event_id` int(11) NOT NULL,
  `map_change_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `universe_id` (`universe_id`),
  KEY `map_id` (`map_id`),
  KEY `map_change_id` (`map_change_id`),
  CONSTRAINT `map_change_versions_ibfk_1` FOREIGN KEY (`universe_id`) REFERENCES `universes` (`id`),
  CONSTRAINT `map_change_versions_ibfk_2` FOREIGN KEY (`map_id`) REFERENCES `maps` (`id`),
  CONSTRAINT `map_change_versions_ibfk_3` FOREIGN KEY (`map_change_id`) REFERENCES `map_changes` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

/*Data for the table `map_change_versions` */

/*Table structure for table `map_changes` */
...
CREATE TABLE `map_changes` (
  ...
  KEY `universe_id` (`universe_id`),
  KEY `map_id` (`map_id`),
  CONSTRAINT `map_changes_ibfk_1` FOREIGN KEY (`universe_id`) REFERENCES `universes` (`id`),
  CONSTRAINT `map_changes_ibfk_2` FOREIGN KEY (`map_id`) REFERENCES `maps` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

/*Data for the table `map_changes` */
...
CREATE TABLE `mapster_entities` (
  ...
  `changes` tinyint(1) NOT NULL DEFAULT '0',
...
insert  into `mapster_entities`(`id`,`name`,`plural`,`changes`,`icon`) values (1,'Universe','Universes',0,'fa fa-space-shuttle'),(2,'Media','Media',0,'fa fa-video-camera'),(3,'Chapter','Chapters',0,'fa fa-book'),(4,'Character','Characters',1,'fa fa-user'),(5,'Character Change','Character Changes',0,NULL),(6,'Map','Maps',1,'fa fa-location-arrow'),(7,'Map Change','Map Changes',0,NULL),(8,'Place','Places',1,'fa fa-map-marker'),(9,'Place Change','Place Changes',0,NULL),(10,'Place Type','Place Types',0,'fa fa-puzzle-piece'),(11,'Event','Events',0,'fa fa-gears');
...
insert  into `mapster_entity_field_types`(`id`,`name`) values (1,'name'),(2,'description'),(3,'image'),(4,'link'),(5,'abbreviation'),(6,'universe'),(7,'media'),(8,'sequence'),(9,'map'),(10,'coordinates'),(11,'place-type'),(12,'chapter'),(13,'character'),(14,'place'),(15,'event');
...
insert  into `mapster_entity_fields`(`mapster_entity_id`,`mapster_entity_field_type_id`,`sequence`) values (1,1,0),(1,2,2),(1,3,3),(1,4,4),(1,5,1),(2,1,0),(2,2,2),(2,3,3),(2,4,4),(2,5,1),(2,6,5),(2,8,6),(3,1,0),(3,2,1),(3,3,2),(3,4,3),(3,7,4),(3,8,5),(4,1,0),(4,2,1),(4,3,2),(4,4,3),(4,6,4),(5,1,0),(5,2,1),(5,3,2),(5,4,3),(5,6,4),(5,13,5),(5,15,6),(6,1,0),(6,2,1),(6,3,2),(6,4,3),(6,6,4),(7,1,0),(7,2,1),(7,3,2),(7,4,3),(7,6,4),(7,9,5),(7,15,6),(8,1,0),(8,2,1),(8,3,2),(8,4,3),(8,9,5),(8,10,6),(8,11,4),(9,1,0),(9,2,1),(9,3,2),(9,4,3),(9,9,4),(9,10,5),(9,11,6),(9,14,7),(9,15,8),(10,1,0),(10,2,1),(10,3,2),(10,4,3),(11,1,0),(11,2,1),(11,4,2),(11,8,3),(11,12,4);
...
/*Table structure for table `place_change_versions` */

DROP TABLE IF EXISTS `place_change_versions`;

CREATE TABLE `place_change_versions` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL,
  `description` text,
  `image` text,
  ...
  `event_id` int(11) NOT NULL,
  `place_change_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `place_type_id` (`place_type_id`),
  KEY `map_id` (`map_id`),
  KEY `place_id` (`place_id`),
  KEY `place_change_id` (`place_change_id`),
  CONSTRAINT `place_change_versions_ibfk_1` FOREIGN KEY (`place_type_id`) REFERENCES `place_types` (`id`),
  CONSTRAINT `place_change_versions_ibfk_2` FOREIGN KEY (`map_id`) REFERENCES `maps` (`id`),
  CONSTRAINT `place_change_versions_ibfk_3` FOREIGN KEY (`place_id`) REFERENCES `places` (`id`),
  CONSTRAINT `place_change_versions_ibfk_4` FOREIGN KEY (`place_change_id`) REFERENCES `place_changes` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

/*Data for the table `place_change_versions` */

/*Table structure for table `place_changes` */

DROP TABLE IF EXISTS `place_changes`;
...
CREATE TABLE `place_changes` (
  ...
  KEY `place_id` (`place_id`),
  KEY `place_type_id` (`place_type_id`),
  CONSTRAINT `place_changes_ibfk_1` FOREIGN KEY (`map_id`) REFERENCES `maps` (`id`),
  CONSTRAINT `place_changes_ibfk_2` FOREIGN KEY (`place_id`) REFERENCES `places` (`id`),
  CONSTRAINT `place_changes_ibfk_3` FOREIGN KEY (`place_type_id`) REFERENCES `place_types` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;

/*Data for the table `place_changes` */

insert  into `place_changes`(`id`,`name`,`description`,`image`,`link`,`place_type_id`,`coordinates`,`map_id`,`created`,`place_id`,`event_id`) values (1,'Altara','Altara is a country located in the south-central part of the Westlands.\n\nThe sign of Altara is two golden leopards on a field checked four-by-four in red and blue.','http://localhost/mapster-api/img/Place/540fd9178dcd3.jpg','http://wot.wikia.com/wiki/Altara',1,'257 205,377 227,266 308,171 228',1,'2015-01-23 11:53:55',1,1);
...
insert  into `place_type_versions`(`id`,`name`,`description`,`image`,`link`,`created`,`place_type_id`) values (1,'asdf',NULL,NULL,NULL,'2015-01-14 15:37:36',1),(2,'asdf',NULL,NULL,NULL,'2015-01-14 15:38:23',1);
...
insert  into `universe_versions`(`id`,`name`,`abbreviation`,`description`,`image`,`link`,`created`,`universe_id`) values (1,'The Wheel of Time','WoT','The Wheel of Time is a series of epic fantasy novels written by American author James Oliver Rigney, Jr., under the pen name Robert Jordan. Originally planned as a six-book series, The Wheel of Time now spans fourteen volumes, in addition to a prequel novel and a companion book. Jordan began writing the first volume, The Eye of the World, in 1984 and it was published in January 1990.','http://localhost/mapster-api/img/UniverseVersions/54124cce84a82.png','http://wot.wikia.com/','2014-09-12 11:30:55',1),(2,'The Wheel of Time','WoT','The Wheel of Time is a series of epic fantasy novels written by American author James Oliver Rigney, Jr., under the pen name Robert Jordan. Originally planned as a six-book series, The Wheel of Time now spans fourteen volumes, in addition to a prequel novel and a companion book. Jordan began writing the first volume, The Eye of the World, in 1984 and it was published in January 1990.','http://localhost/mapster-api/img/UniverseVersions/54b47c4922f84.png','http://wot.wikia.com/s','2015-01-13 12:00:41',1),(17,'The Wheel of Time','WoT','The Wheel of Time is a series of epic fantasy novels written by American author James Oliver Rigney, Jr., under the pen name Robert Jordan. Originally planned as a six-book series, The Wheel of Time now spans fourteen volumes, in addition to a prequel novel and a companion book. Jordan began writing the first volume, The Eye of the World, in 1984 and it was published in January 1990.','http://localhost/mapster-api/img/UniverseVersions/54b4a687235d5.png','http://wot.wikia.com/','2015-01-13 15:00:55',1),(18,'The Wheel of Times','WoT','The Wheel of Time is a series of epic fantasy novels written by American author James Oliver Rigney, Jr., under the pen name Robert Jordan. Originally planned as a six-book series, The Wheel of Time now spans fourteen volumes, in addition to a prequel novel and a companion book. Jordan began writing the first volume, The Eye of the World, in 1984 and it was published in January 1990.','http://localhost/mapster-api/img/UniverseVersions/54b4a6c1aee4f.png','http://wot.wikia.com/','2015-01-13 15:01:53',1),(19,'The Wheel of Time','WoT','The Wheel of Time is a series of epic fantasy novels written by American author James Oliver Rigney, Jr., under the pen name Robert Jordan. Originally planned as a six-book series, The Wheel of Time now spans fourteen volumes, in addition to a prequel novel and a companion book. Jordan began writing the first volume, The Eye of the World, in 1984 and it was published in January 1990.','http://localhost/mapster-api/img/UniverseVersions/54b4a6d386801.png','http://wot.wikia.com/','2015-01-13 15:02:11',1),(20,'The Wheel of Time','WoT','The Wheel of Time is a series of epic fantasy novels written by American author James Oliver Rigney, Jr., under the pen name Robert Jordan. Originally planned as a six-book series, The Wheel of Time now spans fourteen volumes, in addition to a prequel novel and a companion book. Jordan began writing the first volume, The Eye of the World, in 1984 and it was published in January 1990.','','http://wot.wikia.com/','2015-01-13 15:03:41',1),(21,'The Wheel of Time','WoT','The Wheel of Time is a series of epic fantasy novels written by American author James Oliver Rigney, Jr., under the pen name Robert Jordan. Originally planned as a six-book series, The Wheel of Time now spans fourteen volumes, in addition to a prequel novel and a companion book. Jordan began writing the first volume, The Eye of the World, in 1984 and it was published in January 1990.','http://localhost/mapster-api/img/UniverseVersions/54b4a73d88428.png','http://wot.wikia.com/','2015-01-13 15:03:57',1);
