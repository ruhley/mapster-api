...
/**
 * CharacterVersionsFixture
 *
 */
class CharacterVersionsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'character_versions_ibfk_1' => ['type' => 'foreign', 'columns' => ['universe_id'], 'references' => ['universes', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'character_versions_ibfk_2' => ['type' => 'foreign', 'columns' => ['character_id'], 'references' => ['characters', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
