...
/**
 * MediaVersionsFixture
 *
 */
class MediaVersionsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'sequence' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => '1', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'universe_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_constraints' => [
            ...
            'media_versions_ibfk_1' => ['type' => 'foreign', 'columns' => ['universe_id'], 'references' => ['universes', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'media_versions_ibfk_2' => ['type' => 'foreign', 'columns' => ['media_id'], 'references' => ['media', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
